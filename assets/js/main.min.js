          ...
          <div class="row g-4">\
            ...
            <div class="col-12 col-lg-3">\
              ...
              <ul class="list-unstyled footer-contact">\
                ...
                <li><i class="far fa-clock"></i><span>Lundi à Vendredi : 08h – 18h<br>Samedi : 08h – 13h</span></li>\
              </ul>\
...
/* Indice de swipe "‹ ›" inséré au-dessus de chaque rail de cartes (affiché en mobile via CSS) */
(function(){
  var SEL = '.hi-values,.hub-choices,.hub-steps,.fl-pillars,.fl-matrix,.fl-proofgrid,.fl-timeline,.swipe-row,.testi-grid';
  function addCues(){
    var rails = document.querySelectorAll(SEL);
    for(var i=0;i<rails.length;i++){
      var r = rails[i];
      var prev = r.previousElementSibling;
      if(prev && prev.classList && prev.classList.contains('swipe-cue')) continue;
      var cue = document.createElement('div');
      cue.className = 'swipe-cue';
      cue.setAttribute('aria-hidden','true');
      var l = document.createElement('span'); l.className='l'; l.textContent='❮';
      var d = document.createElement('span'); d.className='d'; d.textContent='↓';
      var rr = document.createElement('span'); rr.className='r'; rr.textContent='❯';
      cue.appendChild(l); cue.appendChild(d); cue.appendChild(rr);
      r.parentNode.insertBefore(cue, r);
    }
  }
  if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',addCues);} else {addCues();}
})();
