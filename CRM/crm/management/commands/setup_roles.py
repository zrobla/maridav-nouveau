...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dc_perms += perms_for(models.SalesTarget, "view", "add", "change")
        dc_perms += perms_for(models.Promotion, "view", "add", "change")
        dc_perms += perms_for(models.Warehouse, "view")
        dc_perms += perms_for(models.StockLot, "view", "add", "change")
        dc_perms += perms_for(models.StockMovement, "view", "add")
        ...
        sales_perms += perms_for(models.Warehouse, "view")
        sales_perms += perms_for(models.StockLot, "view")
        sales_perms += perms_for(models.SalesTarget, "view")
        ...
        tech_sales_perms += perms_for(models.Warehouse, "view")
        tech_sales_perms += perms_for(models.StockLot, "view")
        tech_sales_perms += perms_for(models.StockMovement, "view")
        tech_sales_perms += perms_for(models.Forecast, "view")
        tech_sales_perms += perms_for(models.SalesTarget, "view")
        ...
        expert_perms += perms_for(models.StockLot, "view")
        ...
        cashier_perms += perms_for(models.Warehouse, "view")
        cashier_perms += perms_for(models.StockLot, "view")
        cashier_perms += perms_for(models.StockMovement, "view", "add")
        ...
        accounting_perms += perms_for(models.Warehouse, "view")
        accounting_perms += perms_for(models.StockLot, "view")
        accounting_perms += perms_for(models.StockMovement, "view")
        ...
        accounting_perms += perms_for(models.SalesTarget, "view")
